              ...
              <div className="absolute top-full left-0 mt-1 bg-white rounded-lg shadow-2xl z-50 overflow-hidden border-2 border-gray-200 w-full md:w-[350px]">
                <div className="p-3 space-y-3 max-h-[70vh] overflow-y-auto">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center justify-between bg-gray-50 rounded-lg p-2.5">
                        <div className="flex-1">
                          <span className="text-sm font-semibold text-gray-900 block">Adults</span>
                          <p className="text-[10px] text-gray-500">12+ years</p>
                        </div>
                      ...
                      <div className="flex items-center justify-between bg-gray-50 rounded-lg p-2.5">
                        <div className="flex-1">
                          <span className="text-sm font-semibold text-gray-900 block">Children</span>
                          <p className="text-[10px] text-gray-500">2-11 years</p>
                        </div>
                        <div className="flex items-center gap-2">
                          <button
                            type="button"
                      ...
                      <div className="flex items-center justify-between bg-gray-50 rounded-lg p-2.5">
                        <div className="flex-1">
                          <span className="text-sm font-semibold text-gray-900 block">Infants</span>
                          <p className="text-[10px] text-gray-500">Under 2 years</p>
                        </div>
                        <div className="flex items-center gap-2">
                          <button
                            type="button"
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-brand-red to-brand-blue text-white py-2 rounded-lg font-semibold text-sm hover:shadow-lg transition-all duration-200"
                  >
                    Done
                  </button>
                </div>
