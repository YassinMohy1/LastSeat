  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid lg:grid-cols-3 gap-12 mb-16">
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl shadow-xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:border-brand-red focus:outline-none"
                  />
                </div>
                <div>
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-brand-red to-brand-blue text-white py-4 rounded-lg font-bold text-lg hover:shadow-lg transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2"
              >
          ...
          <div className="space-y-6">
            {/* Phone */}
            <div className="bg-gradient-to-br from-brand-red to-brand-blue text-white rounded-2xl p-6 shadow-xl hover:scale-105 transition-transform duration-300">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow">
              <div className="bg-brand-red/10 w-12 h-12 rounded-full flex items-center justify-center mb-4">
        ...
        {/* Emergency Contact */}
        <div className="bg-gradient-to-r from-brand-red to-brand-blue text-white rounded-2xl p-8 text-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-white text-brand-red px-8 py-3 rounded-lg font-bold text-lg hover:bg-gray-100 transition-all duration-300 hover:scale-105"
          >
